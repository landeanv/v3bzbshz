...
clear;clear;clear
echo -e " ${CYAN} ┌─────────────────────────────────────────────────┐${NC}"
echo -e " ${CYAN} │ ${BG_RED}               LANDEAN VPN V3                  ${NC} ${CYAN}│$NC"
echo -e " ${CYAN} └─────────────────────────────────────────────────┘${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/arivpnstores/v3/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/arivpnstores/v3/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/landeanv/v3/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/landeanv/v3/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/landeanv/v3/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/landeanv/v3/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/wkwkwk"},{"text":"Contack","url":"https://wa.me/wkwkwk"}]]}'
...
wget raw.githubusercontent.com/landeanv/v3/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
port 587
auth on
user wkwkwk@gmail.com
from wkwkwk@gmail.com
password wkwkwk
logfile ~/.msmtp.log
EOF
